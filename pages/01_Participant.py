...
def hide_all_researcher_ui():
    ...
    .participant-start-card h2,
    .participant-start-card h3 {
        margin-top: 0;
        color: #111827;
    }
...
def render_pre_experiment_questionnaire() -> None:
    """Collect the full pre-experiment questionnaire before the chat starts."""
    open_questionnaire_card("Pre-experiment questionnaire", "This study investigates how people interact in short text-based conversations similar to mobile messaging. You will be asked to complete a short questionnaire about your communication habits and experience with conversational systems.Your responses will be used for research purposes only and will remain anonymous. The questionnaire takes approximately 3–5 minutes to complete.")
    ...
    with st.form("pre_experiment_questionnaire"):
        ...
        education = st.radio(
            ...
            ["High school", "Undergraduate degree", "Postgraduate degree", "Other"],
            index=None,
        )
        ...
        consent = st.checkbox("By proceeding, you confirm that you are at least 18 years old and consent to participate in this study.")
        close_section()
...
def render_post_experiment_questionnaire() -> None:
    """Collect post-experiment questionnaire after the conversation, while hiding the chat."""
    ...
    with st.form("post_experiment_questionnaire"):
        ...
        engaging = st.radio(
            "How engaging did you find the conversation? *",
            [1, 2, 3, 4, 5],
            index=None,
            horizontal=True,
            captions=["Not engaging at all", "", "", "", "Very engaging"],
        )
        willing_continue = st.radio(
            "How willing would you be to continue this conversation? *",
            [1, 2, 3, 4, 5],
            index=None,
            horizontal=True,
            captions=["Not willing at all", "", "", "", "Very willing"],
        )
        coherent = st.radio(
            "How coherent were the responses during the conversation? *",
            [1, 2, 3, 4, 5],
            index=None,
            horizontal=True,
            captions=["Not coherent at all", "", "", "", "Very coherent"],
        )
        on_topic = st.radio(
            "To what extent did the conversation stay on topic? *",
            [1, 2, 3, 4, 5],
            index=None,
            horizontal=True,
        ...
        natural = st.radio(
            ...
            index=None,
            horizontal=True,
            captions=["Not natural at all", "", "", "", "Very natural"],
        )
        smooth = st.radio(
            "How smooth was the flow of the conversation? *",
            [1, 2, 3, 4, 5],
            index=None,
            horizontal=True,
        ...
        repetitive = st.radio(
            "Did the conversation feel repetitive at any point? *",
            [1, 2, 3, 4, 5],
            index=None,
            horizontal=True,
            captions=["Not at all repetitive", "", "", "", "Very repetitive"],
        )
        followups = st.radio(
            "Did the system ask relevant or helpful follow-up questions? *",
            [1, 2, 3, 4, 5],
            index=None,
            horizontal=True,
            captions=["Not at all", "", "", "", "Very much"],
        ...
        balanced = st.radio(
            "How balanced did the conversation feel? *",
            [1, 2, 3, 4, 5],
            index=None,
            horizontal=True,
            captions=["Very unbalanced", "", "", "", "Very balanced"],
        )
        overall = st.radio(
            "Overall, how would you rate this conversation? *",
            [1, 2, 3, 4, 5],
            index=None,
            horizontal=True,
            captions=["Very poor", "", "", "", "Excellent"],
        )
        close_section()
...
def main():
    st.set_page_config(page_title="Conversation", layout="centered")
